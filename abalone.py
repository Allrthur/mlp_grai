...
#%%
# Load Dataset
CLASS_COLUMN_NAME = "rings"

dataset = pd.read_csv("dataset/abalone/data.csv").dropna()

# Creating one hot encoding
dataset = pd.get_dummies(dataset, columns=["sex", "rings"], dtype=float)
